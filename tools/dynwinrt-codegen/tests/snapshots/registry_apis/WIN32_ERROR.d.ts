...
export declare const enum WIN32_ERROR {
    NO_ERROR = 0,
    ERROR_EXPECTED_SECTION_NAME = -536870912,
    ERROR_BAD_SECTION_NAME_LINE = -536870911,
    ERROR_SECTION_NAME_TOO_LONG = -536870910,
    ERROR_GENERAL_SYNTAX = -536870909,
    ERROR_WRONG_INF_STYLE = -536870656,
    ERROR_SECTION_NOT_FOUND = -536870655,
    ERROR_LINE_NOT_FOUND = -536870654,
    ERROR_NO_BACKUP = -536870653,
    ERROR_NO_ASSOCIATED_CLASS = -536870400,
    ERROR_CLASS_MISMATCH = -536870399,
    ERROR_DUPLICATE_FOUND = -536870398,
    ERROR_NO_DRIVER_SELECTED = -536870397,
    ERROR_KEY_DOES_NOT_EXIST = -536870396,
    ERROR_INVALID_DEVINST_NAME = -536870395,
    ERROR_INVALID_CLASS = -536870394,
    ERROR_DEVINST_ALREADY_EXISTS = -536870393,
    ERROR_DEVINFO_NOT_REGISTERED = -536870392,
    ERROR_INVALID_REG_PROPERTY = -536870391,
    ERROR_NO_INF = -536870390,
    ERROR_NO_SUCH_DEVINST = -536870389,
    ERROR_CANT_LOAD_CLASS_ICON = -536870388,
    ERROR_INVALID_CLASS_INSTALLER = -536870387,
    ERROR_DI_DO_DEFAULT = -536870386,
    ERROR_DI_NOFILECOPY = -536870385,
    ERROR_INVALID_HWPROFILE = -536870384,
    ERROR_NO_DEVICE_SELECTED = -536870383,
    ERROR_DEVINFO_LIST_LOCKED = -536870382,
    ERROR_DEVINFO_DATA_LOCKED = -536870381,
    ERROR_DI_BAD_PATH = -536870380,
    ERROR_NO_CLASSINSTALL_PARAMS = -536870379,
    ERROR_FILEQUEUE_LOCKED = -536870378,
    ERROR_BAD_SERVICE_INSTALLSECT = -536870377,
    ERROR_NO_CLASS_DRIVER_LIST = -536870376,
    ERROR_NO_ASSOCIATED_SERVICE = -536870375,
    ERROR_NO_DEFAULT_DEVICE_INTERFACE = -536870374,
    ERROR_DEVICE_INTERFACE_ACTIVE = -536870373,
    ERROR_DEVICE_INTERFACE_REMOVED = -536870372,
    ERROR_BAD_INTERFACE_INSTALLSECT = -536870371,
    ERROR_NO_SUCH_INTERFACE_CLASS = -536870370,
    ERROR_INVALID_REFERENCE_STRING = -536870369,
    ERROR_INVALID_MACHINENAME = -536870368,
    ERROR_REMOTE_COMM_FAILURE = -536870367,
    ERROR_MACHINE_UNAVAILABLE = -536870366,
    ERROR_NO_CONFIGMGR_SERVICES = -536870365,
    ERROR_INVALID_PROPPAGE_PROVIDER = -536870364,
    ERROR_NO_SUCH_DEVICE_INTERFACE = -536870363,
    ERROR_DI_POSTPROCESSING_REQUIRED = -536870362,
    ERROR_INVALID_COINSTALLER = -536870361,
    ERROR_NO_COMPAT_DRIVERS = -536870360,
    ERROR_NO_DEVICE_ICON = -536870359,
    ERROR_INVALID_INF_LOGCONFIG = -536870358,
    ERROR_DI_DONT_INSTALL = -536870357,
    ERROR_INVALID_FILTER_DRIVER = -536870356,
    ERROR_NON_WINDOWS_NT_DRIVER = -536870355,
    ERROR_NON_WINDOWS_DRIVER = -536870354,
    ERROR_NO_CATALOG_FOR_OEM_INF = -536870353,
    ERROR_DEVINSTALL_QUEUE_NONNATIVE = -536870352,
    ERROR_NOT_DISABLEABLE = -536870351,
    ERROR_CANT_REMOVE_DEVINST = -536870350,
    ERROR_INVALID_TARGET = -536870349,
    ERROR_DRIVER_NONNATIVE = -536870348,
    ERROR_IN_WOW64 = -536870347,
    ERROR_SET_SYSTEM_RESTORE_POINT = -536870346,
    ERROR_SCE_DISABLED = -536870344,
    ERROR_UNKNOWN_EXCEPTION = -536870343,
    ERROR_PNP_REGISTRY_ERROR = -536870342,
    ERROR_REMOTE_REQUEST_UNSUPPORTED = -536870341,
    ERROR_NOT_AN_INSTALLED_OEM_INF = -536870340,
    ERROR_INF_IN_USE_BY_DEVICES = -536870339,
    ERROR_DI_FUNCTION_OBSOLETE = -536870338,
    ERROR_NO_AUTHENTICODE_CATALOG = -536870337,
    ERROR_AUTHENTICODE_DISALLOWED = -536870336,
    ERROR_AUTHENTICODE_TRUSTED_PUBLISHER = -536870335,
    ERROR_AUTHENTICODE_TRUST_NOT_ESTABLISHED = -536870334,
    ERROR_AUTHENTICODE_PUBLISHER_NOT_TRUSTED = -536870333,
    ERROR_SIGNATURE_OSATTRIBUTE_MISMATCH = -536870332,
    ERROR_ONLY_VALIDATE_VIA_AUTHENTICODE = -536870331,
    ERROR_DEVICE_INSTALLER_NOT_READY = -536870330,
    ERROR_DRIVER_STORE_ADD_FAILED = -536870329,
    ERROR_DEVICE_INSTALL_BLOCKED = -536870328,
    ERROR_DRIVER_INSTALL_BLOCKED = -536870327,
    ERROR_WRONG_INF_TYPE = -536870326,
    ERROR_FILE_HASH_NOT_IN_CATALOG = -536870325,
    ERROR_DRIVER_STORE_DELETE_FAILED = -536870324,
    ERROR_UNRECOVERABLE_STACK_OVERFLOW = -536870144,
    ERROR_NO_DEFAULT_INTERFACE_DEVICE = -536870374,
    ERROR_INTERFACE_DEVICE_ACTIVE = -536870373,
    ERROR_INTERFACE_DEVICE_REMOVED = -536870372,
    ERROR_NO_SUCH_INTERFACE_DEVICE = -536870363,
    ERROR_NOT_INSTALLED = -536866816,
    ERROR_SUCCESS = 0,
    ...
    ERROR_SYSTEM_FILE_NOT_SUPPORTED = 525,
    ...
    ERROR_VSMIDK_KEYGEN_FAILURE = 4563,
    ERROR_VSMIDK_EXPORT_FAILURE = 4564,
    ERROR_VSMIDK_MODULUS_MISMATCH = 4565,
    ...
    ERROR_CANNOT_COMPOSE_APISET_EXTENSION = 15380,
    ERROR_APISET_SCHEMA_VERSION_NOT_SUPPORTED = 15381,
    ...
    ERROR_URI_BLOCKED_BY_POLICY_MSIXALLOWEDZONES = 15680,
    ERROR_URI_RECOMMENDED_BLOCK_BY_SMARTSCREEN = 15681,
    ...
    ERROR_NDIS_DOT11_AP_RADIO_RESTRICTION = -2144067575,
    ...
    ERROR_HV_VTL_ALREADY_ENABLED = -1070268282,
    ERROR_HV_SPDM_REQUEST = -1070268280,
