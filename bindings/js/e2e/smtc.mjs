...
import { SystemMediaTransportControls as SmtcProjected } from './smtc-projected/SystemMediaTransportControls.js';
import { MediaPlaybackStatus } from './smtc-projected/MediaPlaybackStatus.js';
